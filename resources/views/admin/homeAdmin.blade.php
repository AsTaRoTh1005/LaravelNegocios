...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="card">
            <h2>Ver Negocios</h2>
            <p>
                Gestiona y revisa todos los negocios registrados en la plataforma. Puedes ver detalles, aprobar nuevos
                negocios y realizar ajustes necesarios.
            </p>
            <a href="" class="btn btn-primary">Ver Negocios</a>
        </div>
        ...
        <div class="card">
            <h2>Ver Usuarios</h2>
            <p>
                Administra a los usuarios registrados en la plataforma. Puedes ver su información, roles y realizar
                acciones de gestión.
            </p>
